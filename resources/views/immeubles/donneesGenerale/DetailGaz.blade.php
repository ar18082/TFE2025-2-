...
{{--                        <label for="Unite" class="form-label"><input type="checkbox" name="Unite"> Prix du m³ de gaz <input type="text" id="PrxGaz"  name="PrxGaz" style="margin-left: 1rem"> </label>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-6 row mt-2">--}}
...
{{--                <div class="col-4 row">--}}
{{--                    <label for="nbrGaz" class="form-label col-6">Nombre de m³ : </label>--}}
{{--                    <input type="text"  id="nbrGaz" name="nbrGaz" class="col-6" style="height: 2rem">--}}
{{--                </div>--}}
{{--                <div class="col-4 row">--}}
{{--                    <label for="prxTotGaz" class="form-label col-6">Prix du m³ : </label>--}}
{{--                    <input type="text"  id="prxTotGaz" name="prxTotGaz" class="col-6" style="height: 2rem">--}}
{{--                </div>--}}
{{--                <div class="col-4 row">--}}
{{--                    <div class="col-12 row">--}}
