    ...
    @forelse($clients as $client)
        ...
        @endphp
            ...
            <div class="row mx-1 mx-md-5 my-2 rounded-1 {{ $bg_card }}">
                <a href="{{ route('immeubles.show',$client->Codecli) }}" class="text-decoration-none rounded-1 col-6 col-md-2 position-relative my-auto order-1 order-md-1 " >
                ...
                <a href="{{ route('immeubles.show',$client->Codecli) }}" class="text-decoration-none rounded-1 col-6 col-md-3 my-0 my-md-auto order-3 order-md-2" >

                    <span class="ms-3 ms-md-0 fw-bold" >
                        {{ $client->nom}}
                    </span>
                </a>
                <a href="{{ route('immeubles.show',$client->Codecli) }}" class="text-decoration-none rounded-1 col-6 col-md-4 my-auto order-2 order-md-3" >

                    {{ $client->rue }}<br> {{ $client->codepost }} {{ $client->codePostelbs->get(0)->Localite }}
                </a>
                <a href="{{ route('immeubles.show',$client->Codecli) }}" class="text-decoration-none rounded-1 col-6 col-md-1 my-auto order-4 order-md-4" >
    ...
    //                        echo '';
                ...
                <div class="rounded-1 col-8 col-md-1 my-auto order-5 order-md-5 d-none d-md-block row">
                        @if(Auth::check() && Auth::user()->role === 'admin')
                            <div class="col-2">
                                <a href="{{ route('admin.event.create') }}?client_id={{$client->id}}" class="btn btn-primary m-1 text-decoration-none py-2">
